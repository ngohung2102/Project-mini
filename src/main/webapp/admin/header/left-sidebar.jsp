...
<div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
    <div class="brand-logo">
        <a href="${pageContext.request.contextPath}/admin/homepage">
            ...
            <h5 class="logo-text">Admin Web Sell Card</h5>
        </a>
    </div>
    <ul class="sidebar-menu do-nicescrol">
        ...
        <li>
            <a href="${pageContext.request.contextPath}/admin/order/detail">
        ...
        <li>
            <a href="${pageContext.request.contextPath}/admin/boardnew/list">
