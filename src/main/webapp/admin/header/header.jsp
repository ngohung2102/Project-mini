...
<html lang="en">
    <head>
        ...
        <title>Admin web Sell Card</title>
                    ...
                    <ul class="navbar-nav align-items-center right-nav-link">
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mt-2 user-title">SellCard</h6>
                                                <b> Admin:  <%=session.getAttribute("account") %></b>                         
                                                <b> Số dư:  <%=100000 %></b>                         
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <li class="dropdown-item"><i class="icon-power mr-2"></i><a href="login"> Đăng xuất</a></li>		
                            </ul>
                        </li>
                    </ul>
                </nav>
