                    ...
                    <div class="aa-product-area">
                        <div class="aa-product-inner">
                            ...
                            <ul class="nav nav-tabs aa-products-tab">
                                <li class="active"><a href="#raucu" data-toggle="tab">Thẻ 1</a></li>
                                <li><a href="#hat" data-toggle="tab">Thẻ 2</a></li>
                                <li><a href="#traicay" data-toggle="tab">Thẻ 3 </a></li>
                                <li><a href="#matong" data-toggle="tab">Thẻ 4</a></li>
                            </ul>
                            <!-- Tab panes -->
                                ...
                                <div class="tab-pane fade in active" id="raucu">
                                    <ul class="aa-product-catg">
                                        ...
                                        <c:forEach items="${product_raucu}" var="product" end="7">
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="${pageContext.request.contextPath}/product/details?id=${product.id}"><img src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${product.image_link}" alt=""></a>
                                                    <a class="aa-add-card-btn"href="${pageContext.request.contextPath}/client/addtocart?product-id=${product.id}"><span class="fa fa-shopping-cart"></span>Thêm vào giỏ hàng</a>
                                                    <figcaption>
                                                        <h4 class="aa-product-title"><a href="${pageContext.request.contextPath}/product/details?id=${product.id}">${product.name }</a></h4>
                                ...
                                <div class="tab-pane fade" id="hat">
                                    <ul class="aa-product-catg">
                                        ...
                                        <c:forEach items="${product_hat}" var="product" end="7">
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="${pageContext.request.contextPath}/product/details?id=${product.id}"><img src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${product.image_link}" alt="polo shirt img"></a>
                                                    <a class="aa-add-card-btn"href="${pageContext.request.contextPath}/client/addtocart?product-id=${product.id}"><span class="fa fa-shopping-cart"></span>Thêm vào giỏ hàng</a>
                                                    <figcaption>
                                                        <h4 class="aa-product-title"><a href="${pageContext.request.contextPath}/product/details?id=${product.id}">${product.name }</a></h4>
                                                            <c:choose>
                            ...
                            <div class="more-product">
                                <a class="aa-browse-btn" href="${pageContext.request.contextPath}/product/list">Xem Tất Cả Sản Phẩm <span class="fa fa-long-arrow-right"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="aa-testimonial-slider">
                        ...
                        <li>
                            <div class="aa-testimonial-single">
                                ...
                                <p>Tôi đã mua hàng ở rất nhiều nơi, nhưng đây là nơi uy tín nhất mà tôi từng mua</p>
                                <div class="aa-testimonial-info">
                                    <p>Trần Quý Bịp</p>
                                    <span>Nhân viên của nhà cái uy tín LUK88</span>
                                </div>
                            </div>
                        </li>
                        <!-- single slide -->
                        <li>
                            <div class="aa-testimonial-single">
                                <img class="aa-testimonial-img" src="${url}/images/davidbecklinh.png" alt="avatar 2">
                                <span class="fa fa-quote-left aa-testimonial-quote"></span>
                                <p> Không nói nhiều. UY TÍN!<p>
                                <div class="aa-testimonial-info">
                                    <p>Vũ Tuấn Linh</p>
                                    <span>Pro-pleier PoKẻ</span>
                                </div>
                            </div>
                        </li>
                        <!-- single slide -->
                        <li>
                            <div class="aa-testimonial-single">
                                <img class="aa-testimonial-img" src="${url}/images/embee.png" alt="avatar 3">
                                <span class="fa fa-quote-left aa-testimonial-quote"></span>
                        ...
                        <li>
                            <div class="aa-testimonial-single">
                                <img class="aa-testimonial-img" src="${url}/images/emtung.png" alt="avatar 4">
                                <span class="fa fa-quote-left aa-testimonial-quote"></span>
                                <p>Cũng uy tín!</p>
                                <div class="aa-testimonial-info">
                                    <p>Quang Tùng</p>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="aa-latest-blog-single">
                                    <figure class="aa-blog-img">                    
                                        <a href="${pageContext.request.contextPath}/boardnew/list/detail?id=${boardnew.id}"><img src="${pageContext.request.contextPath}/view/client/assets/images/news/${boardnew.image_link}" alt="Tin tức ${boardnew.title}"></a>  
                                        <figcaption class="aa-blog-img-caption">
                                            <span href="#"><i class="fa fa-clock-o"></i>${boardnew.created}</span>
                                        </figcaption>                          
                                    </figure>
                                    <div class="aa-blog-info">
                                        <h3 class="aa-blog-title"><a href="${pageContext.request.contextPath}/boardnew/list/detail?id=${boardnew.id}">${boardnew.title}</a></h3>
                                        <p class="desc-boardnews">${boardnew.content}</p> 
                                        <a href="${pageContext.request.contextPath}/boardnew/list/detail?id=${boardnew.id}" class="aa-read-mor-btn">Xem thêm<span class="fa fa-long-arrow-right"></span></a>
                                    </div>
                                </div>
                            </div>
                        </c:forEach>
